...
- (void)loadView
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"Outbox" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if ([[self.msgTypes objectAtIndex:indexPath.row] rangeOfString:@"failed"].location != NSNotFound) {
