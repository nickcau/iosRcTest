...
- (void)loadView
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"Doc" ofType:@"plist"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        cell.imageView.image = [UIImage imageNamed:[@"icon_" stringByAppendingString:[self.msgTypes objectAtIndex:indexPath.row]] ];
