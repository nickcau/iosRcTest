...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (!self.isDismiss) {
        ...
        if (self.direction == ZFModalTransitonDirectionBottom) {
            toViewController.view.transform = CGAffineTransformScale(toViewController.view.transform, scale, scale);
            startRect = CGRectMake(self.orinPoint.x,
                                   self.orinPoint.y,
                                   CGRectGetWidth(toViewController.view.bounds)*scale,
                                   CGRectGetHeight(toViewController.view.bounds)*scale);
...
//        CGPoint transformedPoint = CGPointApplyAffineTransform(startRect.origin, toViewController.view.transform);
        toViewController.view.frame = CGRectMake(self.orinPoint.x, self.orinPoint.y, startRect.size.width, startRect.size.height);
             ...
             usingSpringWithDamping:0.8
              initialSpringVelocity:0.1
                         ...
                         animations:^{
                             ...
                             toViewController.view.transform = CGAffineTransformScale(toViewController.view.transform, 1/scale, 1/scale);
